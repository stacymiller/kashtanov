========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : XLClient
========================================================================


AppWizard has created this XLClient application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your XLClient application.
...
XLClient.h
    ...
    CXLClientApp application class.
...
res\XLClient.ico
    ...
    icon is included by the main resource file XLClient.rc.
...
XLClientDlg.h, XLClientDlg.cpp - the dialog
    These files contain your CXLClientDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in XLClient.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CXLClientDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named XLClient.pch and a precompiled types file named StdAfx.obj.
